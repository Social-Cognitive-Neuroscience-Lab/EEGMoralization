...
## Responses
```{r}
resp_base<- lmer(Response_scale ~ (PriorSupport_scale + SocialSupport.f + ProtestOppose.f)^3 +
...
#### EPN: 100-200
```{r}
m1.mlm.post.e <- lmer(Amplitude ~ Moral + Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = m1 %>% filter(Cluster2 == "Posterior"))
m1.mlm.post.e2 <- lmer(Amplitude ~ (Moral + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = m1 %>% filter(Cluster2 == "Posterior"))

m1.mlm.fc.e <- lmer(Amplitude ~ Moral + Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = m1 %>% filter(Cluster2 == "Frontal"))
m1.mlm.fc.e2 <- lmer(Amplitude ~ (Moral + meta_d)^2 + Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = m1 %>% filter(Cluster2 == "Frontal"))
...
#### MFN/N2: 300-500
```{r}
m2.mlm.fc.e <- lmer(Amplitude ~ Moral + Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = m2 %>% filter(Cluster2 == "Frontal"))
m2.mlm.fc.e2 <- lmer(Amplitude ~ (Moral + meta_d)^2 + Female + Age.z +
                         (1|Subject) + (1|Channel),
                       data = m2 %>% filter(Cluster2 == "Frontal"),
...
#### LPP: 600-800
```{r}
m3.mlm.post.e <- lmer(Amplitude ~ Moral + Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = m3 %>% filter(Cluster2 == "Posterior"))
m3.mlm.post.e2 <- lmer(Amplitude ~ (Moral + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = m3 %>% filter(Cluster2 == "Posterior"))

m3.mlm.fc.e <- lmer(Amplitude ~ Moral + Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = m3 %>% filter(Cluster2 == "Frontal"))
m3.mlm.fc.e2 <- lmer(Amplitude ~ (Moral + meta_d)^2 + Female + Age.z +
                         (1|Subject) + (1|Channel),
                       data = m3 %>% filter(Cluster2 == "Frontal"),
                     control = lmerControl(optimizer = "bobyqa"))
```
...
#### EPN: 125-175
```{r}
ms1.mlm.post.e <- lmer(Amplitude ~ Moral.f * Congruent.f  +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms1 %>% filter(Cluster2 == "Posterior"))
ms1.mlm.post.e2 <- lmer(Amplitude ~ (Moral.f + Congruent.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms1 %>% filter(Cluster2 == "Posterior"))

ms1.mlm.fc.e <- lmer(Amplitude ~ Moral.f * Congruent.f  +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms1 %>% filter(Cluster2 == "Frontal"))
ms1.mlm.fc.e2 <- lmer(Amplitude ~ (Moral.f + Congruent.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms1 %>% filter(Cluster2 == "Frontal"))
```
...
ms2.mlm.post.e <- lmer(Amplitude ~ Moral.f * Congruent.f  +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms2 %>% filter(Cluster2 == "Posterior"))
ms2.mlm.post.e2 <- lmer(Amplitude ~ (Moral.f + Congruent.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms2 %>% filter(Cluster2 == "Posterior"))

ms2.mlm.fc.e <- lmer(Amplitude ~ Moral.f * Congruent.f  +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms2 %>% filter(Cluster2 == "Frontal"))
ms2.mlm.fc.e2 <- lmer(Amplitude ~ (Moral.f + Congruent.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms2 %>% filter(Cluster2 == "Frontal"))
```
...
```{r}
anova(ms2.mlm.post.e, ms2.mlm.post.e2)
```
...
#### LPP: 300-500
```{r}
ms3.mlm.post.e <- lmer(Amplitude ~ Moral.f * Congruent.f  +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms3 %>% filter(Cluster2 == "Posterior"))
ms3.mlm.post.e2 <- lmer(Amplitude ~ (Moral.f + Congruent.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms3 %>% filter(Cluster2 == "Posterior"))

ms3.mlm.fc.e <- lmer(Amplitude ~ Moral.f * Congruent.f  +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms3 %>% filter(Cluster2 == "Frontal"))
ms3.mlm.fc.e2 <- lmer(Amplitude ~ (Moral.f + Congruent.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ms3 %>% filter(Cluster2 == "Frontal"))
```
...
```{r}
ma1.mlm.post.e <- lmer(Amplitude ~ Moral.f * Agree.f +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ma1 %>% filter(Cluster2 == "Posterior"))

ma1.mlm.post.e2 <- lmer(Amplitude ~ (Moral.f + Agree.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ma1 %>% filter(Cluster2 == "Posterior"))

ma1.mlm.fc.e <- lmer(Amplitude ~ Moral.f * Agree.f +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ma1 %>% filter(Cluster2 == "Frontal"),
                     control = lmerControl(optimizer = "bobyqa"))
ma1.mlm.fc.e2 <- lmer(Amplitude ~ (Moral.f + Agree.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ma1 %>% filter(Cluster2 == "Frontal"))
```
...
```{r}
eeg_summary(ma1.mlm.post.e) %>% write_csv("Table_erp_pic_epn.csv")
```
...
#### MFN/N2: 200-400
```{r}
ma2_post = ma2 %>% filter(Cluster2 == "Posterior")
ma2_front = ma2 %>% filter(Cluster2 == "Frontal")
ma2.mlm.post.e <- lmer(Amplitude ~ Moral.f * Agree.f +
                          Female + Age.z + 
                          (1|Subject) + (1|Channel),
                        data = ma2_post)
ma2.mlm.post.e2 <- lmer(Amplitude ~ (Moral.f + Agree.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ma2_post)

ma2.mlm.fc.e <- lmer(Amplitude ~ Moral.f * Agree.f +
                          Female + Age.z + 
                          (1|Subject) + (1|Channel),
                        data = ma2_front)
ma2.mlm.fc.e2 <- lmer(Amplitude ~ (Moral.f + Agree.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ma2_front)
```
...
#### LPP: 400-600 
```{r}
ma3_post = ma3 %>% filter(Cluster2 == "Posterior")
ma3_front = ma3 %>% filter(Cluster2 == "Frontal")
ma3.mlm.post.e <- lmer(Amplitude ~ Moral.f * Agree.f +
                          Female + Age.z + 
                          (1|Subject) + (1|Channel),
                        data = ma3_post)
ma3.mlm.post.e2 <- lmer(Amplitude ~ (Moral.f + Agree.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ma3_post)


ma3.mlm.fc.e <- lmer(Amplitude ~ Moral.f * Agree.f +
                          Female + Age.z + 
                          (1|Subject) + (1|Channel),
                        data = ma3_front)
ma3.mlm.fc.e2 <- lmer(Amplitude ~ (Moral.f + Agree.f + meta_d)^2 +
                          Female + Age.z +
                          (1|Subject) + (1|Channel),
                        data = ma3_front)
```
...
```{r}
eeg_summary(ma3.mlm.fc.e) %>% write_csv("Table_erp_pic_lpp.csv")
```
